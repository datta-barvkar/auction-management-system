...
@Component
public class RestCamelRequestTemplate {
    ...
    public <T> T request(final String endpoint, final Class<T> tClass) {
        try {
            ...
            throw ClientErrorHelper.convertToAuctionRestErrorException(ex);
        } catch (Exception ex) {
            throw new AuctionRestErrorException(Collections.singletonList(ex.getMessage()), INTERNAL_SERVER_ERROR
